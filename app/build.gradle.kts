...
android {
    ...
    defaultConfig {
        ...
        versionCode = (project.findProperty("overdriveVersionCode") as? String)?.toIntOrNull() ?: 127
        versionName = (project.findProperty("overdriveVersionName") as? String) ?: "50.24-fastcam"
