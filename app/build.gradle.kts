...
android {
    ...
    defaultConfig {
        ...
        versionCode = (project.findProperty("overdriveVersionCode") as? String)?.toIntOrNull() ?: 135
        versionName = (project.findProperty("overdriveVersionName") as? String) ?: "50.32-fastcam"
