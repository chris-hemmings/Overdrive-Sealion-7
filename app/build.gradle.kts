...
android {
    ...
    defaultConfig {
        ...
        versionCode = (project.findProperty("overdriveVersionCode") as? String)?.toIntOrNull() ?: 141
        versionName = (project.findProperty("overdriveVersionName") as? String) ?: "50.38-fastcam"
