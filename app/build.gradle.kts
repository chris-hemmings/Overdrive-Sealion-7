...
android {
    ...
    defaultConfig {
        ...
        versionCode = (project.findProperty("overdriveVersionCode") as? String)?.toIntOrNull() ?: 131
        versionName = (project.findProperty("overdriveVersionName") as? String) ?: "50.28-fastcam"
