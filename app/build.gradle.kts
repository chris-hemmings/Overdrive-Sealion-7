...
android {
    ...
    defaultConfig {
        ...
        versionCode = (project.findProperty("overdriveVersionCode") as? String)?.toIntOrNull() ?: 139
        versionName = (project.findProperty("overdriveVersionName") as? String) ?: "50.36-fastcam"
