...
android {
    ...
    defaultConfig {
        ...
        versionCode = (project.findProperty("overdriveVersionCode") as? String)?.toIntOrNull() ?: 143
        versionName = (project.findProperty("overdriveVersionName") as? String) ?: "50.40-fastcam"
