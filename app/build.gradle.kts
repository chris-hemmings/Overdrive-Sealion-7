...
android {
    ...
    defaultConfig {
        ...
        versionCode = (project.findProperty("overdriveVersionCode") as? String)?.toIntOrNull() ?: 132
        versionName = (project.findProperty("overdriveVersionName") as? String) ?: "50.29-fastcam"
