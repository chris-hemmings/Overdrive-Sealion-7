...
android {
    ...
    defaultConfig {
        ...
        versionCode = (project.findProperty("overdriveVersionCode") as? String)?.toIntOrNull() ?: 137
        versionName = (project.findProperty("overdriveVersionName") as? String) ?: "50.34-fastcam"
