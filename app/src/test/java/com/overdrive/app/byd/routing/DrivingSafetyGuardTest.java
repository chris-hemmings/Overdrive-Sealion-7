...
public class DrivingSafetyGuardTest {
    ...
    @Test
    public void parkWithMissingSpeedIsNotBlocked() {
        assertFalse(DrivingSafetyGuard.isBlocked(GearReading.PARK, true, true, Double.NaN));
    }
    ...
    @Test
    public void drivingGearIsBlockedWhenMoving() {
        assertTrue(DrivingSafetyGuard.isBlocked(GearReading.NOT_PARK, true, true, 40.0));
        assertTrue(DrivingSafetyGuard.isBlocked(GearReading.NOT_PARK, true, true, Double.NaN));
        assertFalse(DrivingSafetyGuard.isBlocked(GearReading.NOT_PARK, true, true, 0.0));
    }

    @Test
    public void unknownGearIsBlockedOnlyWhenMoving() {
        assertFalse(DrivingSafetyGuard.isBlocked(GearReading.UNKNOWN, true, true, 0.0));
        assertFalse(DrivingSafetyGuard.isBlocked(GearReading.UNKNOWN, true, true, Double.NaN));
        assertTrue(DrivingSafetyGuard.isBlocked(GearReading.UNKNOWN, true, true, 40.0));
    }
