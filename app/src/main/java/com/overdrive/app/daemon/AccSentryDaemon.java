...
public class AccSentryDaemon {
    ...
    *//**
    ...
    private static boolean isDilink5Unit() {
        try {
            return com.overdrive.app.byd.DiLink5Platform.isActive();
        } catch (Throwable t) {
            return false;
        }
    }
    ...
    private static int readPowerLevel() {
        ...
        if (isDilink5Unit()) {
            int fromPowerMode = readDiLink5PowerLevel();
            if (fromPowerMode >= POWER_LEVEL_OFF
                    && fromPowerMode <= POWER_LEVEL_ON) {
                return fromPowerMode;
            }
        }
        try {
    ...
    private static int readDiLink5PowerLevel() {
        try {
            String line = com.overdrive.app.byd.CarSvcTelemetry.INSTANCE.dumpsysText();
            return com.overdrive.app.monitor.DiLink5PowerMode
                    .classifyBodyworkPowerLevel(line);
        } catch (Throwable t) {
            return -1;
        }
    }
